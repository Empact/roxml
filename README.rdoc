...
This is a short usage example. See ROXML::ClassMethods and packaged test cases for more information.
...
For more information on available annotations, see ROXML::ClassMethods
